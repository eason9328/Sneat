...
export default function Login() {
  ...
  const handleLogin = (e) => {
    ...
    if (!username || !password) {
      ...
      return
    } else if (username !== 'admin@sneat.com' || password !== 'admin') {
      setError(true);
    ...
    navigate('/index/dashboards/analytics');
  }
  ...
  return (
    <div className="login">
      ...
      <div className="right">
        ...
        <div>
          <p className="p1">Welcome to Sneat! 👋🏻</p>
          <p className="p2">Please sign-in to your account and start the adventure</p>
        </div>
        <div className="right2">
          <p>Admin: <span>admin<span className="at">@</span>sneat.com</span> / Pass: <span>admin</span></p>
          <p>Client: <span>client<span className="at">@</span>sneat.com</span> / Pass: <span>client</span></p>
        </div>
        <div>
          <form onSubmit={handleLogin}>
              ...
              sx={{
                '& .MuiOutlinedInput-root': {
                  '&.Mui-focused fieldset': {
                    borderColor: error ? '#ff3e1d' : '#696cff',
                  },
                },
                '& .MuiInputLabel-root.Mui-focused': {
                  color: error ? '#ff3e1d' : '#696cff',
                },
              }}
              autoFocus
              error={error}
            ...
            />
            {error && (
              <div style={{ color: '#ff3e1d', paddingLeft: '15px', fontSize: '0.9rem' }}>
                {errorMessage}
              </div>
            )}
            <TextField
            ...
            <div className="right3">
              <div>
                ...
                <span className="grey">Remember me</span>
              </div>
