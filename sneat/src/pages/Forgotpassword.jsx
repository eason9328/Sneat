...
import img01 from '../imgs/login/8.png';
    ...
    <div className="forgot">
      ...
      <div className="right">
        ...
        <div>
          ...
          <p className="p2">Enter your email and we′ll send you instructions to reset your password</p>
        </div>
        <div>
          <TextField
            sx={{
          ...
          <Link to="/"><p className="p3"> <img src={img01} alt="" /> Back to login </p></Link>
        </div>
      </div>
      </div>
      </div>
